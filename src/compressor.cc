...
symbol_queue<> generate_symbols(std::istream& input, Encoding encoding) {
...
reverse_code_symbol read_symbols(std::istream& input, Encoding encoding) {
...
void compress(options& opts, Encoding encoding) {
...
void decompress(options& opts, Encoding encoding) {
	auto input = std::ifstream(opts.input_file, std::ios_base::binary);
